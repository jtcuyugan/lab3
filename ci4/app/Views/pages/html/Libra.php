	...
	<div id="pageselector">
		<center>
			<ul>
				...
				<li id="buttons"><a href="Libra.php" id="logo"><img src="../images/libra.png" id="logo" padding="none"></img></a></li>
			</ul>
		</center>
		<hr id="header">
	</div>
...
<center>
	<div class="container">
			<img src="../images/libra.png" alt="The Libra Constellation" height="70%">
